<div>
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Add a new article to your blog</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    ></textarea>
                    <p class="mt-1 text-sm text-gray-500">A short summary of your article. If left blank, it will be
                        generated from content.</p>
                </div>
            </div>
