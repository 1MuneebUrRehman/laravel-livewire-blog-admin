<div>
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Welcome to your blog administration panel</p>
    </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $stats['articles_count'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $stats['tags_count'] }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            @endif
                            <div class="ml-4">
                                <h3 class="text-sm font-medium text-gray-900">{{ Str::limit($article->title, 50) }}</h3>
                                <p class="text-sm text-gray-500">
                                    {{ $article->category->name }} • {{ $article->created_at->format('M d, Y') }}
                                </p>
                            </div>
                        </div>
